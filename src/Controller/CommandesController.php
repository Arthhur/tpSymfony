...
class CommandesController extends AbstractController
{
    ...
    /**
     * @Route("/afficher/{id}", name="commandes_client")
     */
    public function afficher(CommandesRepository $commandesRepository, Request $request): Response
    {
        $id = $request->get('id') ;
       
       return $this->render('commandes/afficher.html.twig', [
            'commandes' => $commandesRepository->findByClient($id),
        ]);
    }
